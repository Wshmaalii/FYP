...
export function SignupPage({ onSignup, onSwitchToLogin }: SignupPageProps) {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await onSignup(normalizedUsername, password, undefined);
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <AuthTab label="Sign in" active={false} onClick={onSwitchToLogin} />
          <AuthTab label="Create account" active onClick={() => undefined} />
        </div>
